...
impl App {
    ...
    fn menu_bar_state(&self) -> (bool, bool) {
        ...
        // native windows replaced both overlays — but the REASON the gate exists
        // survives the port and gets a new source: see `native_window_has_key`.

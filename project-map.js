...
window.PROJECT_MAP = {
  ...
  nodes: [
    ...
    },
    {
      ...
      parts: [
        { label: "Frame + TLV + varint core", status: "done", desc: "Frame header, tagged-field walker, LEB128 varints — little-endian and architecture-neutral (checked on x86-64 and riscv64)." },
        ...
        { label: "Handshake messages", status: "done", desc: "Hello/Offer/Claim/Ack/Bye, forward-compatible: unknown tags and message types are skipped and preserved, not fatal." },
